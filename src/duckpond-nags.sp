...
public Plugin myinfo = {
    ...
    version     = "0.2.1",
    url         = "https://github.com/patomario/duckpond-nags"
};
...
public void Event_RoundStart(Event event, const char[] name, bool dontBroadcast) {
    ...
    PrintToChatAll("NOTICE: Be aware there are fake Duck Pond servers");
    PrintToChatAll("Please visit example.com for a list of real servers.");
...
public void Event_RoundEnd(Event event, const char[] name, bool dontBroadcast) {
    MC_PrintToChatAll("{green}Like our servers?{default} ");
